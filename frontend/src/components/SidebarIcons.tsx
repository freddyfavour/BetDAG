...
export function PredictIcon({ className = "" }: { className?: string }) {
  return (
    <svg 
      className={className} 
      xmlns="http://www.w3.org/2000/svg" 
...
export function AdminIcon({ className = "" }: { className?: string }) {
  return (
    <svg 
      ...
      strokeLinejoin="round"
    >
      <path d="M12 4.5a2.5 2.5 0 0 0-4.96-.46 2.5 2.5 0 0 0-1.98 3 2.5 2.5 0 0 0 1.32 4.24 2.5 2.5 0 0 0 1.98 3A2.5 2.5 0 1 0 12 19.5a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 1.98-2.99 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-2.99A2.5 2.5 0 0 0 12 4.5Z"></path>
